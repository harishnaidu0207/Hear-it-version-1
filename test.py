...
if __name__ == "__main__":
    ...
    try:
            ...
            if result == 'angry':
                ...
                randomfile = random.choice(os.listdir("C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Angry/"))
                print('You are angry !!!! please calm down:) ,I will play song for you :' + randomfile)
                file = ('C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Angry/' + randomfile)
                subprocess.call([mp, file])
                #print("Playlist Completed, Please Run program to continue...!!")

            if result == 'happy':
                randomfile = random.choice(os.listdir("C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Happy/"))
                print('You are smiling :) ,I playing special song for you: ' + randomfile)
                file = ('C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Happy/' + randomfile)
                subprocess.call([mp, file])

            if result == 'fear':
                randomfile = random.choice(os.listdir("C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Fear/"))
                print('You have fear of something ,I playing song for you: ' + randomfile)
                file = ('C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Fear/' + randomfile)
                subprocess.call([mp, file])

            if result == 'sad':
                randomfile = random.choice(os.listdir("C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Sad/"))
                print('You are sad,dont worry:) ,I playing song for you: ' + randomfile)
                file = ('C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Sad/' + randomfile)
                subprocess.call([mp, file])
            if result == 'neutral':
                randomfile = random.choice(os.listdir("C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Neutral/"))
                print('You are normal,I playing song for you: ' + randomfile)
                file = ('C:/Users/haris/Downloads/Emotion Detection_NEW/Emotion Detection_NEW/Neutral/' + randomfile)
                subprocess.call([mp, file])  
    except :
